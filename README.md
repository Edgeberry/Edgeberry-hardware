...
>[!important]
>This hardware designed is released under an open source license. **This does not apply to the Edgeberry name and logo**. Without explicit consent from the Edgeberry owners, you can not use the Edgeberry logo (so, for example, when making the hardware board from this repository yourself, you must remove all the logos from the design). You are, however, allowed to refer textually to the Edgeberry project, etc.
